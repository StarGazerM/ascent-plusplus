      ...
      #[allow(unused_imports, noop_method_call, suspicious_double_ref_op)]
      {
         ...
         ascent::internal::comment("scc 0");
         {
            ...
            loop {
               ...
               {
                  if subset_indices_1_2_delta.to_rel_index(&__subset_ind_common_delta).len()
               ...
               {
                  if subset_indices_1_2_total.to_rel_index(&__subset_ind_common_total).len()
                     <= subset_indices_0_2_delta.to_rel_index(&__subset_ind_common_delta).len()
                  {
               ...
               {
                  if subset_indices_2_delta.to_rel_index(&__subset_ind_common_delta).len()
                     <= cfg_edge_indices_0_total.to_rel_index(&__cfg_edge_ind_common_total).len()
                  {
                     subset_indices_2_delta.to_rel_index(&__subset_ind_common_delta).c_iter_all().for_each(
                        |(__cl1_joined_columns, __cl1_tuple_indices)| {
                           let __cl1_joined_columns = __cl1_joined_columns.tuple_of_borrowed();
            ...
            loop {
               ...
               ascent :: internal :: comment ("origin_contains_loan_on_entry <-- origin_contains_loan_on_entry_indices_0_2_delta, subset_indices_0_2_total [SIMPLE JOIN]") ;
               {
                  if origin_contains_loan_on_entry_indices_0_2_delta
                     ...
                     .len()
                     <= subset_indices_0_2_total.to_rel_index(&__subset_ind_common_total).len()
                  {
                              ...
                              .c_index_get(&(origin.clone(), point.clone()))
                           {
                              __cl1_tuple_indices.for_each(|cl1_val| {
                                 ...
                                 __matching.clone().for_each(|__val| {
                                    ...
                                    if !::ascent::internal::RelFullIndexRead::contains_key(
                                       &loan_live_at_indices_0_1_total.to_rel_index(&__loan_live_at_ind_common_total),
                                       &__new_row,
                                    ) && !::ascent::internal::RelFullIndexRead::contains_key(
                                       &loan_live_at_indices_0_1_delta.to_rel_index(&__loan_live_at_ind_common_delta),
                                       &__new_row,
                                    ) {
                                       if ::ascent::internal::CRelFullIndexWrite::insert_if_not_present(
         ...
         ascent::internal::comment("scc 3");
         {
            ...
            #[allow(unused_assignments, unused_variables)]
            {
               ...
               {
                  if loan_invalidated_at_indices_0_1_total.to_rel_index(&__loan_invalidated_at_ind_common_total).len()
                     <= loan_live_at_indices_0_1_total.to_rel_index(&__loan_live_at_ind_common_total).len()
                  {
         ...
         ascent::internal::comment("scc 4");
         {
            ...
            #[allow(unused_assignments, unused_variables)]
            {
               ...
               {
                  if subset_indices_0_total.to_rel_index(&__subset_ind_common_total).len()
                     <= placeholder_origin_indices_0_total.to_rel_index(&__placeholder_origin_ind_common_total).len()
                  {
                     subset_indices_0_total.to_rel_index(&__subset_ind_common_total).c_iter_all().for_each(
                        |(__cl1_joined_columns, __cl1_tuple_indices)| {
                           let __cl1_joined_columns = __cl1_joined_columns.tuple_of_borrowed();
                           let origin1 = __cl1_joined_columns.0;
                                 ...
                                 __matching.clone().for_each(|__val| {
                                       ...
                                       .index_get(&(origin2.clone(),))
                                    {
                                       __matching.for_each(|__val| {
                                          ...
                                          let __matching =
                                             __aggregated_rel.index_get(&(origin1.clone(), origin2.clone()));
                                          let __agg_args = __matching.into_iter().flatten().map(|__val| ());
                                          for () in ::ascent::aggregators::not(__agg_args) {
                                             if origin1 != origin2 {
                                                let __new_row: (T::Origin, T::Origin, T::Point) = (
                                                ...
                                                if !::ascent::internal::RelFullIndexRead::contains_key(
                                                   ...
                                                   if ::ascent::internal::CRelFullIndexWrite::insert_if_not_present(
                                                      ...
                                                      __new_subset_error = _self.subset_error.push((
                                                         __new_row.0,
                                                         __new_row.1,
                                                         __new_row.2,
                                                      ));
